...
head(GPSACQ)
GPSACQ <- GPSACQ[,c(2,3,4,14,13)] # selection des colonnes d'intérêt
...
###############################################################################
# A.4. Ajout d'un champ Day / Night intégrant les variations horaires du lever et coucher du soleil
...
#SUNTABLE$sunrise<-SUNTABLE$sunrise+(0*3600) # les données AWT sont exprimées en UTC+2 -> je rajouter 2 heures à l'heure de lever UTC
#SUNTABLE$sunset<-SUNTABLE$sunset+(2*3600) # les données AWT sont exprimées en UTC+2 -> je rajouter 2 heures à l'heure de coucher UTC
