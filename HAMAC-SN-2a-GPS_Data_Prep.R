...
#### Suppression des plages de donnÈes avec les donnÈes surnumÈraires
...
# Remplace les parties foireuses de 44159 et 44170 par des donnÈes qui marchent.
GPS59 <- read.table(
...
###############################################################################
# A.3. Fen√™tres temporelle et spatiale + retrait iridium
...
# dim(GPSACQ[GPSACQ$HEI>(650),]) # 650 m point le plus haut du S√©n√©gal
...
# 
# #library(MASS)
# # library(rgdal)        => D√©j√† au dessus
# # options(digits = 10)  => D√©j√† au dessus
# 
